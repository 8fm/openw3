...
VS_FAT_VERTEX GenerateVertex( VS_INPUT input )
{
	...
	const float3 worldU = VSC_CameraVectorRight * rotateBilCoordX;
	const float3 worldV = VSC_CameraVectorUp * rotateBilCoordY;
	...
	// Normalized Z coordinate in emitter space
	ret.UV2 = saturate( ( worldPosition.z - VSC_Custom_2.x ) / VSC_Custom_2.z ).xx;
