...
//printf("base offset == %u\n", offset);
    ...
    if (numparams > 0)
    {
        ...
        retval->params = (MOJOSHADER_effectParam *) m((int)siz, d);
    ...
    if (numtechniques > 0)
    {
        ...
        retval->techniques = (MOJOSHADER_effectTechnique *) m((int)siz, d);
        ...
        for (i = 0; i < (int)numtechniques; i++)
        {
            ...
            if (numpasses > 0)
            {
                ...
                technique->passes = (MOJOSHADER_effectPass *) m((int)siz, d);
                ...
                for (j = 0; j < (int)numpasses; j++)
                {
                    ...
                    if (numstates > 0)
                    {
                        ...
                        pass->states = (MOJOSHADER_effectState *) m((int)siz, d);
                        if (pass->states == NULL)
						{
							MOJOSHADER_freeEffect(retval);
							return &MOJOSHADER_out_of_mem_effect;
    ...
    if (numtextures > 0)
    {
        ...
        retval->textures = (MOJOSHADER_effectTexture*)m((int)siz, d);
    ...
    if (numshaders > 0)
    {
        ...
        retval->shaders = (MOJOSHADER_effectShader *) m((int)siz, d);
    ...
    retval->profile = (char *) m((int)strlen(profile) + 1, d);
    if (retval->profile == NULL)
	{
		MOJOSHADER_freeEffect(retval);
		return &MOJOSHADER_out_of_mem_effect;
	}
    strcpy_s((char *) retval->profile, strlen(profile)+1, profile);
