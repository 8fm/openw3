...
#pragma pack(pop)
	...
	//	if (FileSize.LowPart < ( sizeof(DDS_HEADER) + sizeof(Uint32) ) )
	//	{
	//		return E_FAIL;
	//	}
	...
	//	Uint32 dwMagicNumber = *( const Uint32* )( ddsData.get() );
	//	if (dwMagicNumber != DDS_MAGIC)
	//	{
	//		return E_FAIL;
	//	}

	//	auto hdr = reinterpret_cast<DDS_HEADER*>( ddsData.get() + sizeof( Uint32 ) );
	...
	//		if (FileSize.LowPart < ( sizeof(DDS_HEADER) + sizeof(Uint32) + sizeof(DDS_HEADER_DXT10) ) )
	//		{
	//			return E_FAIL;
	//		}
