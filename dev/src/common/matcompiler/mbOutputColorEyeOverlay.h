...
/// A material output block that handles eye overlay AO
class CMaterialBlockOutputColorEyeOverlay : public CMaterialRootBlock
{
	DECLARE_ENGINE_MATERIAL_BLOCK( CMaterialBlockOutputColorEyeOverlay, CMaterialRootBlock, "Deprecated", "Eye Overlay" );
...
BEGIN_CLASS_RTTI( CMaterialBlockOutputColorEyeOverlay )
