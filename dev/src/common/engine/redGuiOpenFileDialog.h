...
namespace RedGui
{
	class CRedGuiOpenFileDialog : public CRedGuiModalWindow
	{
		DECLARE_CLASS_MEMORY_POOL( MemoryPool_RedGui, MC_RedGuiControls );
	public:
		CRedGuiOpenFileDialog();
		virtual ~CRedGuiOpenFileDialog();
	...
	private:
		...
		CRedGuiButton*		m_open;
		CRedGuiTextBox*		m_fileNameTextBox;
		CRedGuiComboBox*	m_openedTypes;
