...
void CPlatform::Initialize( const String& commandLine, const Core::CommandLineArguments& coreArguments )
{
	...
	GUserProfileManager = new CUserProfileManagerLinux();
...
// 		}
	...
	//GInputDeviceManager = new CInputDeviceManagerLinux;
	RED_LOG_ERROR(CPlatform, TXT("FIX_LINUX CPlatform::Initialize"));
