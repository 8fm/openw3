...
#pragma once
#ifndef _REDMATH_LIB_REDQSTRANSFORM_FLOAT_H_
#define _REDMATH_LIB_REDQSTRANSFORM_FLOAT_H_
	...
	namespace Math
	{
		namespace Fpu
		{
			...
			public:
				...
				// EularAngles
				RED_INLINE void SetRotation(const RedMatrix3x3& rotation); 
...
#endif // _REDMATH_LIB_REDQSTRANSFORM_FLOAT_H_
