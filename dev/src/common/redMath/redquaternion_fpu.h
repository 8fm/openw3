...
*/
#pragma once
#ifndef _REDMATH_LIB_QUATERNION_FLOAT_H_
#define _REDMATH_LIB_QUATERNION_FLOAT_H_
	...
	namespace Math
	{
		namespace Fpu
		{
			...
			public:
				...
				RED_INLINE void AddMul( const RedVector1& _a, const RedQuaternion& _b );
...
#endif // _REDMATH_LIB_QUATERNION_FLOAT_H_