    ...
    else
    {
        ...
        if ( !tmp.IsEmpty() )
        {
            ...
            if ( tmp.ToLong(&width) )
                ...
                wxLogDebug(_T("Invalid wxSheetCellFloatRenderer width parameter string '%s ignored"), params.wc_str());
        }
        ...
        if ( !tmp.IsEmpty() )
        {
            ...
            if ( tmp.ToLong(&precision) )
                ...
                wxLogDebug(_T("Invalid wxSheetCellFloatRenderer precision parameter string '%s ignored"), params.wc_str());
        }
    }
}
