...
// Created:     11/04/2001
// RCS-ID:      $Id: sheetedt.cpp,v 1.7 2006/03/28 01:13:29 jrl1 Exp $
...
void wxSheetCellTextEditorRefData::CreateEditor(wxWindow* parent,
                                                ...
                                                wxSheet* sheet)
{
    SetControl(new wxTextCtrlEx(parent, id, wxEmptyString,
...
void wxSheetCellTextEditorRefData::SetParameters(const wxString& params)
{
    ...
    else
    {
        ...
        if ( !params.ToLong(&tmp) )
            wxLogDebug(_T("Invalid wxSheetCellTextEditor parameter string '%s' ignored"), params.wc_str());
        else
...
void wxSheetCellNumberEditorRefData::SetParameters(const wxString& params)
{
    ...
    else
    {
        ...
        wxLogDebug(_T("Invalid wxSheetCellNumberEditor parameter string '%s' ignored"), params.wc_str());
    }
}
...
void wxSheetCellFloatEditorRefData::SetParameters(const wxString& params)
{
    ...
    else
    {
        ...
        wxLogDebug(_T("Invalid wxSheetCellFloatEditor parameter string '%s' ignored"), params.wc_str());
    }
}
