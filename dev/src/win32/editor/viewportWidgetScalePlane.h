...
class CViewportWidgetScalePlane : public CViewportWidgetLines
{
protected:
...
public:
	CViewportWidgetScalePlane( const Vector &scaleAxisTangent, const Vector &scaleAxisBitangent, const Color &axisColor );
