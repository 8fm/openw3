...
public:
    ...
    // --------
    wxTreeListCtrl()
        : m_header_win(0), m_main_win(0), m_headerHeight(0), m_comp_func(0)
    {}
	...
	// tw> MINOR CHANGE: SortChildren() can take a pointer to compare function
	typedef int (*TCompareFuncPtr )(const wxTreeItemId& item1, const wxTreeItemId& item2);

    void SortChildren(const wxTreeItemId& item, TCompareFuncPtr func);
