...
#include "../../../internal/DigitalDistributionIntegration/src/Interface/languages.h"
...
class CUserProfileManagerLinux : public CUserProfileManagerLinuxSaving
{
public:
	CUserProfileManagerLinux();
	virtual ~CUserProfileManagerLinux() override final;
