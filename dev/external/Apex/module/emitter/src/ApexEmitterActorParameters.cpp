...
void ApexEmitterActorParameters::buildTree(void)
{
	...
	// Initialize DefinitionImpl node: nodeIndex=2, longName="attachRelativePose"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=3, longName="emitAssetParticles"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=4, longName="overlapTestGroupMaskName"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=5, longName="overlapTestGroupsMask128Name"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=6, longName="emitterDuration"
	{
