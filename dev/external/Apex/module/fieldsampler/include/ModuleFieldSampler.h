...
class ModuleFieldSampler : public NxModuleFieldSampler, public NiModuleFieldSampler, public Module
{
public:
	...
	void						addPhysXMonitorFilterData(const NxApexScene& apexScene, physx::PxFilterData filterData);
	void						removePhysXMonitorFilterData(const NxApexScene& apexScene, physx::PxFilterData filterData);
#endif

#ifdef APEX_TEST
	virtual bool setPhysXMonitorParticlesData(const NxApexScene& apexScene, physx::PxU32 numParticles, physx::PxVec4** positions, physx::PxVec4** velocities);
	virtual void getPhysXMonitorParticlesData(const NxApexScene& apexScene, physx::PxVec4** velocities);
#endif
