...
public:
	...
	virtual bool setCookedData(NxParameterized::Interface* cookedData, PxF32 cookedActorScale, PxF32 actorScale) = 0;
#if NX_SDK_VERSION_MAJOR == 2
...
#ifndef WITHOUT_PVD
	virtual void updatePvd(physx::debugger::comm::PvdDataStream& /*pvdStream*/, physx::debugger::renderer::PvdImmediateRenderer& /*pvdRenderer*/, NxApexResource* /*clothingActor*/) {};
#endif
