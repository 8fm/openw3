...
public:
	...
	void updateMaxDistanceScale_DEPRECATED(PxF32 scale, bool multipliable);
	const PxMat44& getGlobalPose_DEPRECATED() const;
	void setWind_DEPRECATED(PxF32 windAdaption, const PxVec3& windVelocity);
	void setMaxDistanceBlendTime_DEPRECATED(PxF32 blendTime);
	PxF32 getMaxDistanceBlendTime_DEPRECATED() const;
	void setFlag_DEPRECATED(PxU32 flag, bool val);
	bool getFlag_DEPRECATED(PxU32 flag) const;
	...
	void setLODWeights_DEPRECATED(PxF32 maxDistance, PxF32 distanceWeight, PxF32 bias, PxF32 benefitBias);
	...
	virtual const PxVec3* getSimulationPositions() const;
	virtual const PxVec3* getSimulationNormals() const;
	...
	void clearCollision(ClothingTriangleMesh& triMesh);
...
protected:
	...
	void createSimulation(PxU32 physicalMeshId, PxI32 submeshId, NxParameterized::Interface* cookedData, PxF32 cookedActorScale, const WriteBackInfo& writeBackInfo);
