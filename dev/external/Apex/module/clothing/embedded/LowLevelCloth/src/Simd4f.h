...
struct ProductExpr
{
	inline ProductExpr(Simd4f const& v0, Simd4f const& v1) : v0(v0), v1(v1) {}
...
* \relates Simd4f */
inline Simd4fFactory<detail::OffsetPointer<float> > loadAligned( const float* ptr, int offset )
{
...
* \note \a ptr+offset needs to be 16 byte aligned. 
* \relates Simd4f */
inline void storeAligned( float* ptr, int offset, Simd4f const& v );
