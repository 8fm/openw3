...
NxClothingPhysicalMesh* ClothingIsoMesh::generateClothMesh(PxU32 bubbleSizeToRemove, IProgressListener* progressListener)
{
	...
	clothingPhysicalMesh->setGeometryInternal(false, agmc->getNumVertices(), sizeof(physx::PxVec3), agmc->getVertices(), masterValues.begin(), agmc->getNumIndices(), sizeof(physx::PxU32), agmc->getIndices());
...
NxClothingPhysicalMesh* ClothingIsoMesh::generateSoftbodyMesh(PxU32 tetraSubdivision, IProgressListener* progressListener)
{
	...
	physicalMesh->setGeometryInternal(true, vertices.size(), sizeof(PxVec3), vertices.begin(), masterValues.begin(), indices.size(), sizeof(PxU32), indices.begin());
