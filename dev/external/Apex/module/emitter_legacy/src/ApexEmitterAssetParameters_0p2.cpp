...
void ApexEmitterAssetParameters_0p2::buildTree(void)
{
	...
	// Initialize DefinitionImpl node: nodeIndex=10, longName="velocityRange"
	{
		...
		HintTable[0].init("gameScale", "true", true);
		HintTable[1].init("longDescription", "The emitter actor will create objects with a random velocity within the velocity range.\n", true);
		HintTable[2].init("shortDescription", "Velocity Range", true);
