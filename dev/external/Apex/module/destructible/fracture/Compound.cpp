...
class PhysX3DescTemplateGRB : public PhysX3DescTemplate
{
public:
...
#if RT_USE_GRB
		if (((SimScene*)mScene)->isGrbScene())
		{
			PhysX3DescTemplateGRB physX3Template;
			dactor->getPhysX3Template(physX3Template);
			physX3Template.contactOffset -= physX3Template.restOffset;
			physX3Template.restOffset = 0.f;
