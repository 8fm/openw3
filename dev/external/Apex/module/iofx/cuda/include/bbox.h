...
APEX_CUDA_SYNC_KERNEL(BBOX_WARPS_PER_BLOCK, bboxKernel, ((unsigned int, count))
...
APEX_CUDA_BOUND_KERNEL(BBOX_WARPS_PER_BLOCK, bbox1Kernel,
                       ((unsigned int*, g_actorID))
                       ((unsigned int*, stateToInput))
                       ((const float4*, g_positionMass))
                       ((float4*, g_outMinBounds))((float4*, g_outMaxBounds))
...
APEX_CUDA_BOUND_KERNEL(BBOX_WARPS_PER_BLOCK, bbox2Kernel,
                       ((unsigned int*, g_actorID))
                       ((unsigned int*, stateToInput))
                       ((const float4*, g_positionMass))
                       ((float4*, g_outMinBounds))((float4*, g_outMaxBounds))
