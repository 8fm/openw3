...
void NoiseFSActorParams::buildTree(void)
{
	...
	// Initialize DefinitionImpl node: nodeIndex=2, longName="initialScale"
	{
		...
		static HintImpl HintTable[2];
		static Hint* HintPtrTable[2] = { &HintTable[0], &HintTable[1], };
		HintTable[0].init("longDescription", "The initial scale factor of the boundary shape.  The default value is 1.0.", true);
		HintTable[1].init("shortDescription", "The initial scale factor of the boundary shape.", true);
	...
	// Initialize DefinitionImpl node: nodeIndex=3, longName="fieldBoundaryFilterDataName"
	{
		...
		HintTable[0].init("shortDescription", "The filter data name for NoiseFS vs Field Boundaries interaction. Overrides asset's value.", true);
