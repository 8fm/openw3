...
void AttractorFSActorParams::buildTree(void)
{
	...
	// Initialize DefinitionImpl node: nodeIndex=1, longName="position"
	{
		...
		HintTable[0].init("shortDescription", "The global position for the actor.", true);
	...
	// Initialize DefinitionImpl node: nodeIndex=2, longName="fieldBoundaryFilterDataName"
	{
	...
	// Initialize DefinitionImpl node: nodeIndex=3, longName="fieldSamplerFilterDataName"
	{
...
void AttractorFSActorParams::initDefaults(void)
{
	...
	freeReferences();
	freeDynamicArrays();
	position = physx::PxVec3(init(0, 0, 0));
