...
private:
	...
	struct TetraEdge
	{
		void init(physx::PxU32 v0, physx::PxU32 v1, physx::PxU32 tetra, int neighborNr = -1)
		{
			this->tetraNr = tetra;
			this->neighborNr = neighborNr;
			PX_ASSERT(v0 != v1);
			vNr0 = physx::PxMin(v0, v1);
			vNr1 = physx::PxMax(v0, v1);
		}
	...
	struct TetraEdgeList
	{
		...
		TetraEdge& operator[](int i)
		{
			return mEdges[i];
		}
		const TetraEdge& operator[](int i) const
		{
			return mEdges[i];
		}
