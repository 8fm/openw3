...
public:
	...
	*/
	virtual void setContactReportFlags(PxShape* shape, PxPairFlags flags, NxDestructibleActor* actor, PxU16 actorChunkIndex, PxU16 depth) = 0;
...
public:
	...
	*/
	virtual void simulate(physx::PxF32 elapsedTime, 
						  bool finalStep = true, 
						  physx::PxTask *completionTask = NULL) = 0;
#else
