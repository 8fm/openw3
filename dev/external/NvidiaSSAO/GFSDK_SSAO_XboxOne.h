...
//    * Setting the DepthStorage parameter to FP16_VIEW_DEPTHS uses less video memory but may introduce artifacts for large view depths.
//---------------------------------------------------------------------------------------------------
...
{
    GFSDK_SSAO_DepthStorage             DepthStorage;           // Format of the internal view-depth texture
