...
PxsParticleData* PxsParticleData::create(PxvParticleSystemStateDataDesc& particles, const PxBounds3& bounds)
{
	...
	PxsParticleData* mem = (PxsParticleData*)align16.allocate(getTotalSize(particles.maxParticles, particles.restOffsets.ptr() != NULL), __FILE__, __LINE__);
...
{
	Ps::AlignedAllocator<16, Ps::ReflectionAllocator<PxsParticleData> > align16;
	PxsParticleData* mem = (PxsParticleData*)align16.allocate(getTotalSize(maxParticles, perParticleRestOffsets), __FILE__, __LINE__);
