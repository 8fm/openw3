...
static void solveContactCoulomb4_Block(const PxcSolverConstraintDesc* PX_RESTRICT desc, PxcSolverContext& /*cache*/)
{
	...
	PxcSolverContactCoulombHeader4* PX_RESTRICT firstHeader = (PxcSolverContactCoulombHeader4* PX_RESTRICT)currPtr;
...
static void solveFriction4_Block(const PxcSolverConstraintDesc* PX_RESTRICT desc, PxcSolverContext& /*cache*/)
{
	...
	{
		PxcSolverFrictionHeader4* PX_RESTRICT hdr = (PxcSolverFrictionHeader4* PX_RESTRICT)currPtr;
...
static void concludeContactCoulomb4(const PxcSolverConstraintDesc* desc, PxcSolverContext& /*cache*/)
{
	...
	const PxcSolverContactCoulombHeader4* PX_RESTRICT firstHeader = (const PxcSolverContactCoulombHeader4* PX_RESTRICT)cPtr;
	...
	while(cPtr < last)
	{
		const PxcSolverContactCoulombHeader4* PX_RESTRICT hdr = (const PxcSolverContactCoulombHeader4* PX_RESTRICT)cPtr;
		...
		for(PxU32 i=0;i<numNormalConstr;i++)
		{
			PxcSolverContact4Base *c = reinterpret_cast<PxcSolverContact4Base* PX_RESTRICT>(cPtr);
			cPtr += pointStride;
