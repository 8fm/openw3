...
class BroadPhaseBatchUpdateWorkTask: public physx::PxLightCpuTask
{
public:
	...
	virtual const char* getName() const { return "BroadPhaseBatchUpdate"; }
...
public:
	...
	friend class SapPostUpdateWorkTask;
										...
										PxsBroadPhaseContextSap(PxcScratchAllocator& scratchAllocator);
	virtual								~PxsBroadPhaseContextSap();

	static PxsBroadPhaseContextSap*		create(PxcScratchAllocator& scratchAllocator);
