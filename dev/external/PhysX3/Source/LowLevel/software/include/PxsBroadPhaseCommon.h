...
struct IntegerAABB
{
	...
	PX_FORCE_INLINE PxcBPValType& getMinX() { return mMinMax[MIN_X]; }
	PX_FORCE_INLINE PxcBPValType& getMinY() { return mMinMax[MIN_Y]; }
	PX_FORCE_INLINE PxcBPValType& getMinZ() { return mMinMax[MIN_Z]; }
	PX_FORCE_INLINE PxcBPValType& getMaxX() { return mMinMax[MAX_X]; }
	PX_FORCE_INLINE PxcBPValType& getMaxY() { return mMinMax[MAX_Y]; }
	PX_FORCE_INLINE PxcBPValType& getMaxZ() { return mMinMax[MAX_Z]; }
