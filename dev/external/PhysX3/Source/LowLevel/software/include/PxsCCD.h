...
#define CCD_POST_DEPENETRATE_ENABLE				0
...
private:
	...
	*/
		...
		Array<PxsCCDBody*> mIslandBodies;
		Array<PxU16> mIslandSizes;
		...
		Array<PxsCCDPair*> mCCDPtrPairs;
		// number of pairs per island
		Array<PxU32> mCCDIslandHistogram; 
