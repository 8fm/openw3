...
private:
	...
	void reorderParticleIndicesToPackets(PxU32* sortedIndices, PxU32 numHashedParticles, const PxsFluidParticle* particles, const Cm::BitMap& particleMap, PxU16* hashKeyArray);
