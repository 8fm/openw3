...
namespace physx
{
	...
	class SapUpdateWorkTask: public physx::PxLightCpuTask
	{
	public:
		...
		virtual const char* getName() const { return "SapUpdateWorkTask"; }
	...
	class SapPostUpdateWorkTask: public physx::PxLightCpuTask
	{
	public:
		...
		virtual const char* getName() const { return "SapPostUpdateWorkTask"; }
