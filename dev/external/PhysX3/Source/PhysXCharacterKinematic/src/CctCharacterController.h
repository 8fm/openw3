...
#pragma pack(pop)
	...
	enum SweepTestFlag
	{
		...
		STF_HIT_FORCE_NON_WALKABLE	= (1<<9),
		STF_PREVENT_CLIMB			= (1<<10),
		SFT_UP_SLIDE_ITERATION		= (1<<11),
	};	
	...
	public:
		...
		bool				doSweepTest(
			...
			PxU32* nb_collisions, PxF32 min_dist, const PxControllerFilters& filters, SweepPass sweepPass/*, PxVec3 sideMove*/ );
