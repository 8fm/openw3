 ...
 */
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
bool Gu::CreatePolygonPlane(PxPlane& plane, PxU32 nb_verts, const PxU32* indices, const PxVec3* verts)
{
	// Checkings
	...
	for(PxU32 VRef0=0;VRef0<nb_verts;VRef0++)
	{
		...
		const PxTriangle T(verts[indices[VRef0]], verts[indices[VRef1]], verts[indices[VRef2]]);
	...
	// Compute plane using best triangle
	{
		...
		const PxU32 VRef1 = (VRef0 + Step) % nb_verts;
		const PxU32 VRef2 = (VRef1 + Step) % nb_verts;
		plane = PxPlane(verts[indices[VRef0]], verts[indices[VRef1]], verts[indices[VRef2]]);
	}
 ...
 */
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//bool Gu::ComputeNewellPlane(Plane& plane, PxU32 nb_verts, const PxU32* indices, const PxVec3* verts)
bool Gu::ComputeNewellPlane(PxPlane& plane, PxU32 nb_verts, const PxU8* indices, const PxVec3* verts)
{
	// Checkings
	if(!nb_verts || !indices || !verts)	return false;
	...
	plane.n = Normal;
	plane.n.normalize();
	plane.d = -(Centroid.dot(plane.n))/float(nb_verts);
