...
namespace Gu
{
	...
	class PX_PHYSX_COMMON_API SphereCollider : public VolumeCollider
	{
		public:
											SphereCollider();
		...
		PX_FORCE_INLINE		Ps::IntBool		SphereAABBOverlap(const Vec3V center, const Vec3V extents) const;
#endif
		PX_FORCE_INLINE		Ps::IntBool		SphereAABBOverlap(const PxVec3& center, const PxVec3& extents) const;
	...
	class PX_PHYSX_COMMON_API HybridSphereCollider : public SphereCollider
	{
	public:
												HybridSphereCollider() : mCallback(NULL), mUserData(NULL)	{}
		PX_FORCE_INLINE							~HybridSphereCollider()										{}

						bool					Collide(ReportSphereCallback cb, void* userData, const Gu::Sphere& sphere, const RTreeMidphaseData& model, const Cm::Matrix34* worlds=NULL, const Cm::Matrix34* worldm=NULL);
	//protected:
