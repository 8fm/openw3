...
// 224 => 208 => 192 bytes
	...
	PX_DEF_BIN_METADATA_ITEM(stream,	InternalTriangleMeshData, RTreeMidphase,	mOpcodeModel,			0)
...
void Gu::GeometryUnion::getBinaryMetaData(PxOutputStream& stream)
{
	...
	public:
		...
		{
			PX_DEF_BIN_METADATA_CLASS(stream,	ShadowConvexMeshGeometry)
			PX_DEF_BIN_METADATA_ITEM(stream,	ShadowConvexMeshGeometry, PxGeometryType::Enum,	mType,		0)
			PX_DEF_BIN_METADATA_ITEM(stream,	ShadowConvexMeshGeometry, PxMeshScale,			scale,		0)
			PX_DEF_BIN_METADATA_ITEM(stream,	ShadowConvexMeshGeometry, PxConvexMesh,			convexMesh,	PxMetaDataFlag::ePTR)
			PX_DEF_BIN_METADATA_ITEM(stream,	ShadowConvexMeshGeometry, ConvexHullData,		hullData,	PxMetaDataFlag::ePTR)
		}
	};
	...
	public:
		static void getBinaryMetaData(PxOutputStream& stream)
		{
			PX_DEF_BIN_METADATA_TYPEDEF(stream, PxMeshGeometryFlags, PxU8)

			PX_DEF_BIN_METADATA_CLASS(stream,	ShadowTriangleMeshGeometry)
			PX_DEF_BIN_METADATA_ITEM(stream,	ShadowTriangleMeshGeometry, PxGeometryType::Enum,		mType,				0)
			PX_DEF_BIN_METADATA_ITEM(stream,	ShadowTriangleMeshGeometry, PxMeshScale,				scale,				0)
			PX_DEF_BIN_METADATA_ITEM(stream,	ShadowTriangleMeshGeometry, PxMeshGeometryFlags,		meshFlags,			0)
			PX_DEF_BIN_METADATA_ITEMS(stream,	ShadowTriangleMeshGeometry,	PxU8,						paddingFromFlags,	PxMetaDataFlag::ePADDING, 3)
			PX_DEF_BIN_METADATA_ITEM(stream,	ShadowTriangleMeshGeometry, PxTriangleMesh,				triangleMesh,		PxMetaDataFlag::ePTR)
			PX_DEF_BIN_METADATA_ITEM(stream,	ShadowTriangleMeshGeometry, InternalTriangleMeshData,	meshData,			PxMetaDataFlag::ePTR)
			PX_DEF_BIN_METADATA_ITEM(stream,	ShadowTriangleMeshGeometry, PxU16,						materialIndices,	PxMetaDataFlag::ePTR)
			PX_DEF_BIN_METADATA_ITEM(stream,	ShadowTriangleMeshGeometry, MaterialIndicesStruct,		materials,			0)
		}
	};
	...
	public:
		static void getBinaryMetaData(PxOutputStream& stream)
		{
			PX_DEF_BIN_METADATA_CLASS(stream,		ShadowHeightFieldGeometry)
			PX_DEF_BIN_METADATA_ITEM(stream,		ShadowHeightFieldGeometry, PxGeometryType::Enum,	mType,					0)
			PX_DEF_BIN_METADATA_ITEM(stream,		ShadowHeightFieldGeometry, PxHeightField,		    heightField,			PxMetaDataFlag::ePTR)
			PX_DEF_BIN_METADATA_ITEM(stream,		ShadowHeightFieldGeometry, PxReal,					heightScale,			0)
			PX_DEF_BIN_METADATA_ITEM(stream,		ShadowHeightFieldGeometry, PxReal,					rowScale,				0)
			PX_DEF_BIN_METADATA_ITEM(stream,		ShadowHeightFieldGeometry, PxReal,					columnScale,			0)
			PX_DEF_BIN_METADATA_ITEM(stream,		ShadowHeightFieldGeometry, PxMeshGeometryFlags,		heightFieldFlags,		0)
			PX_DEF_BIN_METADATA_ITEMS_AUTO(stream,	ShadowHeightFieldGeometry, PxU8,					paddingFromFlags,		PxMetaDataFlag::ePADDING)
			PX_DEF_BIN_METADATA_ITEM(stream,		ShadowHeightFieldGeometry, HeightField,				heightFieldData,		PxMetaDataFlag::ePTR)
			PX_DEF_BIN_METADATA_ITEM(stream,		ShadowHeightFieldGeometry, MaterialIndicesStruct,	materials,				0)
		}
	};
	...
	public:
		static void getBinaryMetaData(PxOutputStream& stream)
		{
			PX_DEF_BIN_METADATA_CLASS(stream,	ShadowPlaneGeometry)
			PX_DEF_BIN_METADATA_ITEM(stream,	ShadowPlaneGeometry, PxGeometryType::Enum,	mType,		0)
		}
	};
	...
	public:
		static void getBinaryMetaData(PxOutputStream& stream)
		{
			PX_DEF_BIN_METADATA_CLASS(stream,	ShadowSphereGeometry)
			PX_DEF_BIN_METADATA_ITEM(stream,	ShadowSphereGeometry, PxGeometryType::Enum,		mType,		0)
			PX_DEF_BIN_METADATA_ITEM(stream,	ShadowSphereGeometry, PxReal,				    radius,		0)
		}
	};
	...
	public:
		static void getBinaryMetaData(PxOutputStream& stream)
		{
			PX_DEF_BIN_METADATA_CLASS(stream,	ShadowCapsuleGeometry)
			PX_DEF_BIN_METADATA_ITEM(stream,	ShadowCapsuleGeometry, PxGeometryType::Enum,	mType,		0)
			PX_DEF_BIN_METADATA_ITEM(stream,	ShadowCapsuleGeometry, PxReal,					radius,		0)
			PX_DEF_BIN_METADATA_ITEM(stream,	ShadowCapsuleGeometry, PxReal,					halfHeight,	0)
		}
	};
	...
	public:
		static void getBinaryMetaData(PxOutputStream& stream)
		{
			PX_DEF_BIN_METADATA_CLASS(stream,	ShadowBoxGeometry)
			PX_DEF_BIN_METADATA_ITEM(stream,	ShadowBoxGeometry, PxGeometryType::Enum,	mType,		0)
			PX_DEF_BIN_METADATA_ITEM(stream,	ShadowBoxGeometry, PxVec3,					halfExtents,0)
		}
	};
