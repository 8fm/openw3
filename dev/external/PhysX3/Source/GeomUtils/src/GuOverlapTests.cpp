...
const Gu::GeomOverlapSphereFunc* Gu::GetGeomOverlapSphereMap()
{
	return &Gu::gGeomOverlapSphereMap[0];
}
...
const Gu::GeomOverlapOBBFunc* Gu::GetGeomOverlapOBBMap()
{
	return &Gu::gGeomOverlapOBBMap[0];
}
...
const Gu::GeomOverlapCapsuleFunc* Gu::GetGeomOverlapCapsuleMap()
{
	return &Gu::gGeomOverlapCapsuleMap[0];
}
...
//	const PxPlaneGeometry& planeGeom = static_cast<const PxPlaneGeometry&>(geom0);
	...
	Gu::projectHull_(cm->getHull(), minimum, maximum, shapeSpacePlane.n, convexGeom.scale.toMat33());
...
static bool GeomOverlapCallback_ConvexConvex(GEOM_OVERLAP_CALLBACK_PARAMS)
{
	...
	GU_FETCH_CONVEX_DATA(convexGeom0);
	cm0 = cm;
	bool overlap;
...
Gu::GeomOverlapFunc Gu::GetGeomOverlapMethodTable(int type1, int type2)
{
	return Gu::gGeomOverlapMethodTable[type1][type2];
}

Gu::GeomOverlapFunc Gu::gGeomOverlapMethodTable[][7] = 
{
...
{
	Gu::gGeomOverlapMethodTable[PxGeometryType::eSPHERE][PxGeometryType::eHEIGHTFIELD] = GeomOverlapCallback_SphereHeightfield;
	Gu::gGeomOverlapMethodTable[PxGeometryType::ePLANE][PxGeometryType::eHEIGHTFIELD] = GeomOverlapCallback_PlaneHeightfield;
	Gu::gGeomOverlapMethodTable[PxGeometryType::eCAPSULE][PxGeometryType::eHEIGHTFIELD] = GeomOverlapCallback_CapsuleHeightfield;
	Gu::gGeomOverlapMethodTable[PxGeometryType::eBOX][PxGeometryType::eHEIGHTFIELD] = GeomOverlapCallback_BoxHeightfield;
	Gu::gGeomOverlapMethodTable[PxGeometryType::eCONVEXMESH][PxGeometryType::eHEIGHTFIELD] = GeomOverlapCallback_ConvexHeightfield;
	Gu::gGeomOverlapMethodTable[PxGeometryType::eTRIANGLEMESH][PxGeometryType::eHEIGHTFIELD] = GeomOverlapCallback_MeshHeightfield;
	Gu::gGeomOverlapMethodTable[PxGeometryType::eHEIGHTFIELD][PxGeometryType::eHEIGHTFIELD] = GeomOverlapCallback_HeightfieldHeightfield;
}
