...
//~PX_SERIALIZATION
	...
	PX_INLINE	void getReadWriteCudaBuffersGpu(PxCudaReadWriteParticleBuffers& buffers);
	PX_INLINE	void setValidParticleRangeGpu(PxU32 validParticleRange);
	PX_INLINE	void setDeviceExclusiveModeFlagsGpu(PxU32 flags);
	PX_INLINE	bool isInDeviceExclusiveModeGpu() const;
#endif
...
#if PX_SUPPORT_GPU_PHYSX
PX_INLINE void ParticleSystem::getReadWriteCudaBuffersGpu(PxCudaReadWriteParticleBuffers& buffers)
{
	getScParticleSystem().getReadWriteCudaBuffersGpu(buffers);
}

PX_INLINE void ParticleSystem::setValidParticleRangeGpu(PxU32 validParticleRange)
{
	getScParticleSystem().setValidParticleRangeGpu(validParticleRange);
}

PX_INLINE void ParticleSystem::setDeviceExclusiveModeFlagsGpu(PxU32 flags)
{
	getScParticleSystem().setDeviceExclusiveModeFlagsGpu(flags);
}

PX_INLINE bool ParticleSystem::isInDeviceExclusiveModeGpu() const
{
	return getScParticleSystem().isInDeviceExclusiveModeGpu();
}
