...
//~PX_SERIALIZATION
	...
	PX_FORCE_INLINE const Core&					getActorCore() const 	{ return *reinterpret_cast<const Core*>(reinterpret_cast<const size_t>(this) + sOffsets.scbToSc[getScbType()]); }
					Core&						getActorCore()			{ return *reinterpret_cast<Core*>(reinterpret_cast<size_t>(this) + sOffsets.scbToSc[getScbType()]); }


	PX_FORCE_INLINE static const Actor&			fromSc(const Core& a)	{ return *reinterpret_cast<const Actor*>(reinterpret_cast<const size_t>(&a) - sOffsets.scToScb[a.getActorCoreType()]); }
