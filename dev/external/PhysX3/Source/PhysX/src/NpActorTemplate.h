...
void NpActorTemplate<APIClass>::setName(const char* debugName)
{
	...
	GRB_EVENT(getScene(), PxSceneEvent, PxSceneEvent::PxActorSetName, static_cast<PxActor *>(this), debugName);
	...
	if(scbScene 
		&& scbScene->getSceneVisualDebugger().isConnected()
...
void NpActorTemplate<APIClass>::setDominanceGroup(PxDominanceGroup dominanceGroup)
{
	...
	GRB_EVENT(getScene(), PxSceneEvent, PxSceneEvent::PxActorSetDominanceGroup, static_cast<PxActor *>(this), dominanceGroup);
}
...
PX_FORCE_INLINE void NpActorTemplate<APIClass>::setActorFlagInternal(PxActorFlag::Enum flag, bool value)
{
	...
	GRB_EVENT(getScene(), PxSceneEvent, PxSceneEvent::PxActorSetFlags, static_cast<PxActor *>(this), (PxU32)a.getActorFlags());
}
...
PX_FORCE_INLINE void NpActorTemplate<APIClass>::setActorFlagsInternal(PxActorFlags inFlags)
{
	...
	GRB_EVENT(getScene(), PxSceneEvent, PxSceneEvent::PxActorSetFlags, static_cast<PxActor *>(this), (PxU32)inFlags);
}
