...
{
public:
	PxSceneEventStream(NpScene * scene, shdfnd::Array<PxSceneEvent> * eventStream) : scene(scene),eventStream(eventStream) {}
	...
	PX_INLINE const PxSceneEvent & operator[](unsigned n) const
	{
		return (*eventStream)[n];
	}

	PX_INLINE PxSceneEvent & operator[](unsigned n)
	{
		return (*eventStream)[n];
	}

	shdfnd::Array<PxSceneEvent> * getEventStream()
	{
		return eventStream;
	}
...
private:
	...
	shdfnd::Array<PxSceneEvent> * eventStream;
