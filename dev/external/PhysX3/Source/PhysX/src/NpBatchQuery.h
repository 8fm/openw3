...
public:
	...
	virtual void							raycast(const PxVec3& origin, const PxVec3& unitDir, PxReal distance, PxU16 maxTouchHits,
													...
													void* userData, const PxQueryCache* cache) const;
	...
	virtual void							sweep(const PxGeometry& geometry, const PxTransform& pose,
												...
												PxHitFlags hitFlags, const PxQueryFilterData& filterData,
												void* userData, const PxQueryCache* cache, const PxReal inflation) const;
...
private:
	...
	// this class gets loaded directly to SPU
						NpScene*			mNpScene;
	mutable				BatchQueryStream	mStream;
	mutable				PxU32				mNbRaycasts, mNbOverlaps, mNbSweeps;
	mutable volatile	PxI32				mBatchQueryIsRunning;
	...
	mutable				PxU32				mPrevOffset;

			void							writeBatchHeader(const BatchStreamHeader& h) const;
