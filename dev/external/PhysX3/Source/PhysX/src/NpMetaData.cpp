...
static void getBinaryMetaData_BitMap(PxOutputStream& stream)
{
	...
	public:
		...
		{
			PX_DEF_BIN_METADATA_CLASS(stream,		ShadowBitMap)
			PX_DEF_BIN_METADATA_ITEM(stream,		ShadowBitMap, PxU32,		mMap,		PxMetaDataFlag::ePTR)
			PX_DEF_BIN_METADATA_ITEM(stream,		ShadowBitMap, PxU32,		mWordCount,	0)
			PX_DEF_BIN_METADATA_ITEM(stream,		ShadowBitMap, Allocator,	mAllocator,	0)
			PX_DEF_BIN_METADATA_ITEMS_AUTO(stream,	ShadowBitMap, PxU8,			mPadding,	PxMetaDataFlag::ePADDING)

			//------ Extra-data ------

			// mMap
			PX_DEF_BIN_METADATA_EXTRA_ARRAY(stream,	ShadowBitMap, PxU32, mWordCount, PX_SERIAL_ALIGN, PxMetaDataFlag::eCOUNT_MASK_MSB)
		}
	};
...
static void getBinaryMetaData_PtrTable(PxOutputStream& stream)
{
...
static void getFoundationMetaData(PxOutputStream& stream)
{
	...
	getBinaryMetaData_PtrTable(stream);
