...
,	mName				(NULL)
,	mInternalShapeFlags (isExclusive ? NpInternalShapeFlag::eEXCLUSIVE : 0)
{
...
{	
	...
	// this only leaves us with the option of acquiring the material through the context given an old material index (we do have the mapping)
	{
		...
		for (PxU32 i=0; i < nbIndices; i++)
		{
			...
			NpMaterial& material = *reinterpret_cast<NpMaterial*>(base);
...
void NpShape::release()
{
	...
	GRB_EVENT(getOwnerScene(), PxSceneEvent, PxSceneEvent::PxShapeRelease, static_cast<PxShape *>(this), (PxU8)1);
...
void NpShape::setGeometry(const PxGeometry& g)
{
	...
	GRB_EVENT(getOwnerScene(), PxSceneEvent, PxSceneEvent::PxShapeSetGeometry, static_cast<PxShape *>(this), g);
}
...
void NpShape::setLocalPose(const PxTransform& newShape2Actor)
{
	...
	GRB_EVENT(getOwnerScene(), PxSceneEvent, PxSceneEvent::PxShapeSetLocalPose, static_cast<PxShape *>(this), newShape2Actor);
}
...
void NpShape::setSimulationFilterData(const PxFilterData& data)
{
	...
	GRB_EVENT(getOwnerScene(), PxSceneEvent, PxSceneEvent::PxShapeSetSimulationFilterData, static_cast<PxShape *>(this), data);
}
...
void NpShape::setQueryFilterData(const PxFilterData& data)
{
	...
	GRB_EVENT(getOwnerScene(), PxSceneEvent, PxSceneEvent::PxShapeSetQueryFilterData, static_cast<PxShape *>(this), data);
}
...
void NpShape::setMaterials(PxMaterial*const* materials, PxU16 materialCount)
{
	...
	GRB_EVENT(getOwnerScene(), PxSceneEvent, PxSceneEvent::PxShapeSetMaterials, static_cast<PxShape *>(this), materials, materialCount);
}
...
PxMaterial* NpShape::getMaterialFromInternalFaceIndex(PxU32 faceIndex) const
{
	...
	if(getGeometryType() == PxGeometryType::eHEIGHTFIELD)
	{
	...
	else if(getGeometryType() == PxGeometryType::eTRIANGLEMESH)
	{
	...
	if( hitMatTableId == PxHeightFieldMaterial::eHOLE )
	{
		return 0;
	}
...
void NpShape::setContactOffset(PxReal contactOffset)
{
	...
	GRB_EVENT(getOwnerScene(), PxSceneEvent, PxSceneEvent::PxShapeSetContactOffset, static_cast<PxShape *>(this), contactOffset);
}
...
void NpShape::setRestOffset(PxReal restOffset)
{
	...
	GRB_EVENT(getOwnerScene(), PxSceneEvent, PxSceneEvent::PxShapeSetRestOffset, static_cast<PxShape *>(this), restOffset);
}
...
void NpShape::setFlag(PxShapeFlag::Enum flag, bool value)
{
	...
	GRB_EVENT(getOwnerScene(), PxSceneEvent, PxSceneEvent::PxShapeSetFlags, static_cast<PxShape *>(this), (PxU32)shapeFlags);
}
...
void NpShape::setFlags( PxShapeFlags inFlags )
{
	...
	GRB_EVENT(getOwnerScene(), PxSceneEvent, PxSceneEvent::PxShapeSetFlags, static_cast<PxShape *>(this), (PxU32)inFlags);
}
...
void NpShape::setName(const char* debugName)		
{
	...
	GRB_EVENT(getOwnerScene(), PxSceneEvent, PxSceneEvent::PxShapeSetName, static_cast<PxShape *>(this), debugName);
