...
ConnImpl::ConnImpl()
	...
	, mNtQueryInfo( 0 )
{
#if defined(PX_XBOXONE)
	//@todo. Implement me when DLL loading comes online??
#else	//#if defined(PX_XBOXONE)
#ifdef UNICODE
#if defined(PX_X64)
...
#if 0  // unreferenced (unused by XboxOne PAUtils)
