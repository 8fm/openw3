...
{
	VECMATHAOS_ASSERT(0 == ((PxU64)f & 0x0f));
	return _mm_and_ps(_mm_load_ps(f), reinterpret_cast<const Vec4V&>(internalWindowsSimd::gMaskXYZ));
}
...
{
	return _mm_and_ps(v, reinterpret_cast<const Vec4V&>(internalWindowsSimd::gMaskXYZ));
}
