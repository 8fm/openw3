...
namespace Sc
{
	...
	public:
		...
		PX_FORCE_INLINE	PxU32			getBroadphaseGroupId()	const	{ return (getActorType()!=PxActorType::eRIGID_STATIC ? mRigidId + BP_GROUP_DYNAMICS : BP_GROUP_STATICS);}

		void							updateCachedShapeState();
