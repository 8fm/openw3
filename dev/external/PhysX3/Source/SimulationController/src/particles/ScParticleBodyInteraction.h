...
namespace Sc
{
	...
	public:
		...
		void initialize(bool secondaryBroadphase);
		void destroy(bool isDyingRb, bool secondaryBroadphase);
	...
	private:
		void activateForLowLevel(bool secondaryBroadphase);
		void deactivateForLowLevel(bool isDyingRb, bool secondaryBroadphase);
...
PX_INLINE void Sc::ParticleElementRbElementInteraction::updateState()
{
