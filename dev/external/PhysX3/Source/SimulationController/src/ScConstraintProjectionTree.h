...
namespace Sc
{
	...
	public:
		...
		*/
		...
		private:
			static	ConstraintGroupNode*	buildOneProjectionTree(ConstraintGroupNode& root, ConstraintSim* constraintToWorld);
			static	ConstraintGroupNode*	buildBodyTree(ConstraintGroupNode* parent, ConstraintGroupNode& node, ConstraintSim* toParent);

			static	void					rankConstraint(ConstraintSim&, BodyRank&);
