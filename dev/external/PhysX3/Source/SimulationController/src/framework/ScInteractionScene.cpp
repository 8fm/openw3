...
void Sc::InteractionScene::preAllocate(PxU32 nbBodies, PxU32 nbStaticShapes, PxU32 nbDynamicShapes)
{
...
//	mInactiveActors.reserve(nbActors);
	...
	if(mLLContext)
		mLLContext->preAllocate(nbBodies, nbStaticShapes, nbDynamicShapes);
}
...
void  Sc::InteractionScene::releaseConstraints()
{
