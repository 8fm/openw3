...
void Sc::ElementInteractionMarker::updateState()
{
	ElementSimInteraction::updateState();
}


bool Sc::ElementInteractionMarker::onActivate()
{
	return false;
}


bool Sc::ElementInteractionMarker::onDeactivate()
{
	return true;
}
