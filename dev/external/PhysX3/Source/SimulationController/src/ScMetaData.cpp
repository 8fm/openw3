...
void Sc::ActorCore::getBinaryMetaData(PxOutputStream& stream)
{
	...
	PX_DEF_BIN_METADATA_ITEM(stream,	Sc::ActorCore, PxU32,			    mCompoundID,			0)
...
static void getBinaryMetaData_PxsBodyCore(PxOutputStream& stream)
{
	...
	PX_DEF_BIN_METADATA_ITEM(stream,		PxsBodyCore, PxReal,		mWakeCounter,			0)
...
// 176 => 144 bytes
	...
	PX_DEF_BIN_METADATA_ITEM(stream,		Sc::BodyCore, PxReal,		mSleepDamping,			0)
	PX_DEF_BIN_METADATA_ITEM(stream,		Sc::BodyCore, SimStateData,	mSimStateData,			PxMetaDataFlag::ePTR)
#ifdef EXPLICIT_PADDING_METADATA
	PX_DEF_BIN_METADATA_ITEMS_AUTO(stream,	Sc::BodyCore, PxU32,		mPaddingBodyCore,		PxMetaDataFlag::ePADDING)
#endif
}
...
#ifdef EXPLICIT_PADDING_METADATA
	PX_DEF_BIN_METADATA_ITEMS_AUTO(stream,	PxsArticulationJointCore, PxU8,			paddingFromSwingLimited,	PxMetaDataFlag::ePADDING)
#endif
