...
namespace Sc
{
	...
	public:
		...
		PX_FORCE_INLINE	BodySim*				getBody(PxU32 i)  // for static actors or world attached constraints NULL is returned
												{
													return mBodies[i];
												}
		...
		PX_FORCE_INLINE	PxU8					readFlag(PxU8 flag) const { return (mFlags & flag); }
