...
namespace Sc
{
	...
	public:
		...
		PX_INLINE		PxReal							getContactOffset()		const	{ return mCore.getContactOffset();	}
						...
						void							createLowLevelVolume(PxU32 group, const PxBounds3& bounds, PxU32 compoundID, AABBMgrId aabbMgrId);
	...
	private:
					...
					PxBounds3							computeWorldBounds(const ShapeCore& core, const RigidSim& actor)				const;
