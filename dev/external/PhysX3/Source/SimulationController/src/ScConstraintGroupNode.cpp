...
void Sc::ConstraintGroupNode::initProjectionData(ConstraintGroupNode* parent, ConstraintSim* c)
{
	...
	if (parent)
	{
		projectionNextSibling = parent->projectionFirstChild;
		parent->projectionFirstChild = this;

		projectionParent = parent;
	}
}
