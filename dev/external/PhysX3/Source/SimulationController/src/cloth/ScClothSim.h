...
namespace Sc
{
	...
	public:
		...
		void addCollisionSphere(const ShapeSim* shape);
		void removeCollisionSphere(const ShapeSim* shape);

		void addCollisionCapsule(const ShapeSim* shape);
		void removeCollisionCapsule(const ShapeSim* shape);

		void addCollisionPlane(const ShapeSim* shape);
		void removeCollisionPlane(const ShapeSim* shape);

		void addCollisionBox(const ShapeSim* shape);
		void removeCollisionBox(const ShapeSim* shape);

		void addCollisionConvex(const ShapeSim* shape);
		void removeCollisionConvex(const ShapeSim* shape);

		void addCollisionMesh(const ShapeSim* shape);
		void removeCollisionMesh(const ShapeSim* shape);

		void addCollisionHeightfield(const ShapeSim* shape);
