...
namespace
{
	...
	*/
	///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	VolumeIntegrator::VolumeIntegrator(PxSimpleTriangleMesh mesh, PxF64	density)
	{
		mDensity	= density;
		mMass		= 0.0;
		this->mesh	= mesh;
	...
	*/
	///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	bool VolumeIntegratorEberly::computeVolumeIntegrals(PxIntegrals& ir)
	{
		...
		for(PxU32 i=0;i<mMesh.triangles.count;i++, trigPointer += mMesh.triangles.stride)
		{
			...
			PxVec3 p0 = (*(PxVec3 *)(vertPointer + mMesh.points.stride * i0));
			PxVec3 p1 = (*(PxVec3 *)(vertPointer + mMesh.points.stride * i1));
			PxVec3 p2 = (*(PxVec3 *)(vertPointer + mMesh.points.stride * i2));
...
// Wrapper
bool computeVolumeIntegralsEberly(const PxSimpleTriangleMesh& mesh, PxReal density, PxIntegrals& integrals)
{
	VolumeIntegratorEberly v(mesh, density);
	v.computeVolumeIntegrals(integrals);
