...
cloth::CuFactory::CuFactory(CudaContextManager* contextManager)
: Factory(GPU), 
...
void cloth::CuFactory::copyToHost( const void* srcIt, const void* srcEnd, void* dstIt ) const
{
	...
	checkSuccess( cuMemcpyDtoH(dstIt, CUdeviceptr(srcIt), intptr_t(srcEnd)-intptr_t(srcIt)) );
}
...
void cloth::CuFactory::copyFromHost( const void* srcIt, const void* srcEnd, void* dstIt ) const
{
	...
	checkSuccess( cuMemcpyHtoD(CUdeviceptr(dstIt), srcIt, intptr_t(srcEnd)-intptr_t(srcIt)) );
}
...
void cloth::CuFactory::copyToHost( const void* srcIt, const void* srcEnd, void* dstIt, CUstream stream ) const
{
	...
	checkSuccess( cuMemcpyDtoHAsync(dstIt, CUdeviceptr(srcIt), intptr_t(srcEnd)-intptr_t(srcIt), stream)  );
}
...
void cloth::CuFactory::copyFromHost( const void* srcIt, const void* srcEnd, void* dstIt, CUstream stream ) const
{
	...
	checkSuccess( cuMemcpyHtoDAsync(CUdeviceptr(dstIt), srcIt, intptr_t(srcEnd)-intptr_t(srcIt), stream) );
}
