...
* \relates Simd4i */
inline Simd4iFactory<detail::OffsetPointer<int> > loadAligned( const int* ptr, int offset )
{
...
* \note \a ptr+offset needs to be 16 byte aligned. 
* \relates Simd4i */
inline void storeAligned( int* ptr, int offset, const Simd4i& v );
