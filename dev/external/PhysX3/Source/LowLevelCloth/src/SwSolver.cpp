...
: mProfiler(profiler), 
  mSimulateEventId(mProfiler ? mProfiler->getEventIdForName("cloth::SwSolver::simulate") : -1),
...
{
	if(mProfiler)
		mProfiler->startEvent(mSimulateEventId, intptr_t(this), uint32_t(intptr_t(this)));
}

void cloth::SwSolver::endFrame() const
{
	if(mProfiler)
		mProfiler->stopEvent(mSimulateEventId, intptr_t(this), uint32_t(intptr_t(this)));
}
...
void cloth::SwSolver::StartSimulationTask::run()
{
	mSolver->beginFrame();
...
{
	return "cloth::SwSolver::StartSimulationTask";
}

void cloth::SwSolver::EndSimulationTask::run()
{
...
{
	return "cloth::SwSolver::EndSimulationTask";
}
...
void cloth::SwSolver::CpuClothSimulationTask::run()
{	
...
{
	return "cloth::SwSolver::CpuClothSimulationTask";
}
...
{
	return "cloth::SwSolver::SpuClothSimulationWorkerTask";
}
