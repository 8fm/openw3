...
namespace physx { namespace debugger {
	...
	public:
		...
		virtual PxU32 getUpdatedInstances( InstanceDescription* outBuffer, PxU32 count, PxU32 startIndex = 0 ) const = 0;
	...
	public:
		...
		static PvdObjectModel& create( PxAllocatorCallback& callback, PvdObjectModelMetaData& metaData );
	};
}}
