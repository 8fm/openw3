...
#define TelemetryRunTimeVersion   "2.0N"   EXPMACRO
#define LTelemetryRunTimeVersion L"2.0N"   EXPMACRO
#define Telemetry2Version   "2.0N"   EXPMACRO
#define LTelemetry2Version L"2.0N"   EXPMACRO

#define TelemetryMajorVersion    2  EXPMACRO    
#define TelemetryMinorVersion    0  EXPMACRO    
#define TelemetryBuildNumber    55  EXPMACRO    
...
EXPTYPE typedef enum TmPlotType
{
    ...
    TMPT_TIME_CLOCKS = 9,          // U64 clock cycles
...
EXPTYPE typedef enum TmOpenFlag
{
    ...
    TMOF_MINIMAL_CONTEXT_SWITCHES  = 0x0020,      // Currently sames as $TMOF_MODERATE_CONTEXT_SWITCHES
...
#if ( defined __RADNT__ || defined __RADLINUX__ || defined __RADMAC__ ) && !defined TM_API_STATIC
