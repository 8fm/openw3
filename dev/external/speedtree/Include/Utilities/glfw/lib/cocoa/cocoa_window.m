...
{
    _glfwInputMouseClick( (int)[event buttonNumber], GLFW_PRESS );
}
...
{
    _glfwInputMouseClick( (int)[event buttonNumber], GLFW_RELEASE );
}
...
{
    unsigned int newModifierFlags = (unsigned int)([event modifierFlags] | NSDeviceIndependentModifierFlagsMask);
    int mode;
