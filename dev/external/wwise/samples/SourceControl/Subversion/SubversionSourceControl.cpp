...
void SubversionSourceControl::Init( ISourceControlUtilities* in_pUtilities, bool in_bAutoAccept )
{
	...
	svn_client_get_simple_provider( &pProvider, m_pGlobalPool );
	APR_ARRAY_PUSH( pProviders, svn_auth_provider_object_t* ) = pProvider;
	svn_client_get_username_provider( &pProvider, m_pGlobalPool );
	APR_ARRAY_PUSH( pProviders, svn_auth_provider_object_t* ) = pProvider;

	// The server-cert, client-cert, and client-cert-password providers.
	svn_client_get_ssl_server_trust_file_provider( &pProvider, m_pGlobalPool );
	APR_ARRAY_PUSH( pProviders, svn_auth_provider_object_t* ) = pProvider;
	svn_client_get_ssl_client_cert_file_provider( &pProvider, m_pGlobalPool );
	APR_ARRAY_PUSH( pProviders, svn_auth_provider_object_t* ) = pProvider;
	svn_client_get_ssl_client_cert_pw_file_provider( &pProvider, m_pGlobalPool );
	APR_ARRAY_PUSH( pProviders, svn_auth_provider_object_t* ) = pProvider;
