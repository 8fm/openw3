...
namespace FilePackager.Packaging
{
    ...
    internal class FileOrganizer
    {
        ...
        public void AddLUT(FileType in_eType, FileLUT fileLUTs)
        {
            ...
            if (in_ordered != null)
            {
                foreach (FilePackageGenerator.Context.PackageItem item in in_ordered)
                {
                    ...
                    else if (item.Descriptor != null)
                    {
                        ...
                        if (item.Descriptor.GetType() == typeof(AK.Wwise.InfoFile.StreamedFiles))
                            fileType = FileType.StreamedAudio;
                    }

                    // Select proper LUT.
                    FileLUT lut = m_arFileLUTs[fileType];
        ...
        private Dictionary<FileType, FileLUT> m_arFileLUTs = new Dictionary<FileType, FileLUT>();
