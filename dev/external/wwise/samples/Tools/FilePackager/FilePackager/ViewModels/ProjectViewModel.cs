...
namespace FilePackager.ViewModels
{
	...
	public class ProjectViewModel : ViewModelBase
	{
        ...
        private AK.Wwise.InfoFile.Platform _platform;
        ...
        public AK.Wwise.InfoFile.Platform Platform
        {
            ...
            using (new AutoCursor(Cursors.Wait))
            {
                ...
                if (System.IO.File.Exists(infoPath))
                {
                    ...
                    if (soundBankInfo != null)
                    {
                        try
                        {
                            Platform = soundBankInfo.Platform;
                            ...
                            IEnumerable<AK.Wwise.InfoFile.FileDescriptorType> fileDescriptors =
                                soundBankInfo.SoundBanks.SoundBankCollection.Cast<AK.Wwise.InfoFile.FileDescriptorType>()
                                .Concat(soundBankInfo.StreamedFiles.FileCollection.Cast<AK.Wwise.InfoFile.FileDescriptorType>());
        ...
        private void BuildPackages(IEnumerable<PackageViewModel> packages)
        {
            ...
            context.Global.Platform = Platform;
