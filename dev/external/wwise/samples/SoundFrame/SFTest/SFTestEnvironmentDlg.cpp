...
CSFTestAuxBusDlg::AuxBusSettings::AuxBusSettings()
{
	m_sVolumes.fCenter = m_sVolumes.fFrontLeft = m_sVolumes.fFrontRight = m_sVolumes.fLfe = m_sVolumes.fRearLeft = m_sVolumes.fRearRight = 1.0f;
}
