...
int WINAPI WinMain( HINSTANCE hInstance, HINSTANCE hPrevInstance, LPSTR lpCmdLine, int nCmdShow )
{
	...
	if ( !IntegrationDemo::Instance().Init( memSettings, stmSettings, deviceSettings, initSettings, platformInitSettings, musicInit, hWnd, szError, IntegrationDemoHelpers::AK_ARRAYSIZE(szError), width, height ) )
	{
		AkOSChar szMsg[550];
