...
bool DemoBGMusic::Init()
{
	...
	AK::SoundEngine::AddSecondaryOutput(0 /*Ignored for BGM*/, AkSink_BGM, 0x80 /*Use the listener #8 (bit mask)*/);
...
void DemoBGMusic::Release()
{
	...
	AK::SoundEngine::RemoveSecondaryOutput(0 /*Ignored for BGM*/, AkSink_BGM);
}
