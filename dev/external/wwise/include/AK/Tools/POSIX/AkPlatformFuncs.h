...
#define AkExitThread( _result ) return _result;
									 ...
									 char*	io_pszAnsiString )
	{
		...
		int ConvRet = wcstombs(io_pszAnsiString,  in_pszUnicodeString, in_uiOutBufferSize);
									 ...
									 wchar_t*			io_pvUnicodeStringBuffer )
	{
		...
		AkInt32 ConvRet = mbstowcs((wchar_t *)io_pvUnicodeStringBuffer, in_pszAnsiString, in_uiOutBufferSize );
