...
typedef unsigned long long	AkUInt64;			///< Unsigned 64-bit integer

typedef long AkIntPtr;							///< Integer type for pointers
typedef unsigned long AkUIntPtr;					///< Integer (unsigned) type for pointers

typedef signed char			AkInt8;					///< Signed 8-bit integer
typedef signed short		AkInt16;				///< Signed 16-bit integer
typedef signed long   		AkInt32;				///< Signed 32-bit integer
typedef signed int 			AkInt;					///< Signed integer
typedef signed long long	AkInt64;				///< Signed 64-bit integer
