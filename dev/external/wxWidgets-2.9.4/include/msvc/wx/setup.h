...
// architecture-specific part: not used (again, for compatibility), for x86
    ...
    #define wxARCH_SUFFIX_DIR x64
#elif defined(_M_IA64)
    #define wxARCH_SUFFIX _ia64
    #define wxARCH_SUFFIX_DIR ia64
#else // assume _M_IX86
    #define wxARCH_SUFFIX
    #define wxARCH_SUFFIX_DIR win32
#endif

#ifdef WXUSINGDLL
    #define wxLIB_SUBDIR wxCONCAT4(wxCOMPILER_PREFIX, _dll, /, wxARCH_SUFFIX_DIR)
#else // !DLL
    #define wxLIB_SUBDIR wxCONCAT4(wxCOMPILER_PREFIX, _lib, /, wxARCH_SUFFIX_DIR)
#endif // DLL/!DLL
